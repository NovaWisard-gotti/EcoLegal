package com.educalab.verdelegal.data.repository

import com.educalab.verdelegal.data.local.AppDatabase
import com.educalab.verdelegal.data.local.entity.*
import com.educalab.verdelegal.data.local.seed.*
import com.educalab.verdelegal.domain.engine.*
import com.educalab.verdelegal.domain.model.*
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.map

/**
 * Punto único de acceso a los datos de VerdeLegal. Combina las consultas Room
 ...
 */
class VerdeLegalRepository(private val db: AppDatabase) {
