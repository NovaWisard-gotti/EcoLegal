...
import com.educalab.verdelegal.data.local.entity.Badge
...
object BadgeSeed {
    val badges = listOf(
        ...
        Badge(12, "MAESTRO_VERDELEGAL", "Maestro VerdeLegal", "Dominaste por completo todas las zonas del Valle Verde.", "badge_master", "ALL_ZONES_MASTERED")
    )
}
