...
import com.educalab.verdelegal.data.local.seed.BadgeSeed
import com.educalab.verdelegal.domain.model.BadgeInfo
import com.educalab.verdelegal.domain.model.RewardContext
...
class RewardEngineTest {
    ...
    @Test
    fun `maestro verdelegal requires every zone mastered`() {
